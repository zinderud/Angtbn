...
import { EventManager, AlertService } from '../../libs/libs.module';
import { Subscription } from 'rxjs/Rx';

@Component({
    selector: 'tbn-alert-error',
    template: `
...
export class TbnAlertErrorComponent implements OnDestroy {
    ...
    constructor(private alertService: AlertService, private eventManager: EventManager, private translateService: TranslateService) {
        ...
        this.cleanHttpErrorListener = eventManager.subscribe('bsnApp.httpError', (response) => {
            let i;
                ...
                case 400:
                    ...
                    if (errorHeader) {
                        ...
                        for (i = 0; i < fieldErrors.length; i++) {
                            ...
                            const fieldName = translateService.instant('bsnApp.' +
